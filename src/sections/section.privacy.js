...
and is intended for use as is.
    ...
    {" "}
    <br />
    The information that I request is will be retained by us and used as described in this privacy
    policy.
    <br />
    {" "}
    <br />
    ...
    operating system version, configuration of the app when utilising my Serice, the time and date
    ...
    your devices’s internal memory.
    <br />
    {" "}
    <br />
    This Services does not uses these “cookies” explicitly. However, the app may use third party
    ...
    services; or To assist us in analyzing how our Service is used. I want to inform users of this
