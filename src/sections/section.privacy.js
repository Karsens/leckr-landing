...
const PrivacyPage = () => (
  <Container>
    {Settings.companyName} built their apps as a freemium app. This SERVICE is
    provided by {Settings.companyName} and is intended for use as is.
    <br /> <br />
    ...
    and Conditions, unless otherwise defined in this Privacy Policy.
    <br /> <br />
    ...
    your devices’s Internet Protocol (“IP”) address, device name, operating
    system version, configuration of the app when utilising my Serice, the time
    ...
    that you visit and are stored on your devices’s internal memory.
    <br /> <br />
    This Services does not uses these “cookies” explicitly. However, the app may
    ...
    device. If you choose to refuse our cookies, you may not be able to use some
    ...
    used. I want to inform users of this Service that these third parties have
    ...
    Children’s Privacy
    <br /> <br />
    This Services do not address anyone under the age of 13. I do not knowingly
    collect personal identifiable information from children under 13. In the
